...
//         {/* <div className="absolute inset-0 bg-gradient-to-br from-indigo-900/80 via-indigo-800/85 to-purple-900/80 backdrop-blur-sm"></div> */}
//         <div className="absolute inset-0 from-indigo-900/80 via-indigo-800/85 to-purple-900/80 backdrop-blur-sm"></div>
//       </div>
